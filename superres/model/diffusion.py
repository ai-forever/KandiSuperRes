...
#             algorithm_type="sde-dpmsolver++",
    ...
    @torch.no_grad()    
    def pred_noise(self, model, x, t, lowres_img):
        pred_noise = model(x.to(dtype=torch.float16), t.to(dtype=torch.float16), lowres_img=lowres_img)
...
#         panorama_width /= 8
    ...
    def generate_panorama(self, height, width,  device, num_inference_steps, 
        ...
        for i, time in tqdm(enumerate(self.dpm_solver.timesteps)):
            ...
            for j, batch_view in enumerate(views_batch):
                ...
                pred_noise = self.pred_noise(
                    unet, img_for_view, t, lowres_img_for_view
                )
